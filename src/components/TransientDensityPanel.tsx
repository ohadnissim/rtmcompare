...
const SECTION_COLOR: Record<string, string> = {
 'Intro': '#6b6470',
 'Verse': 'var(--color-teal)',
 'Verse / Pre-chorus': 'var(--color-teal)',
 'Breakdown': 'var(--color-slate-blue)',
 'Drop / Chorus': 'var(--color-accent)',
 'Climax': 'var(--color-warning)',
 'Outro': '#6b6470',
}
...
export default function TransientDensityPanel({ density, durationSec, onSectionScrub }: {
 ...
 <h2 className="text-lg">Transient Density & Structure</h2>
 ...
 fill="var(--color-accent)" opacity={0.25 + p.density * 0.35} />
 )
 })}

 {/* Energy curve */}
 <path d={energyPath} fill="none" stroke="var(--color-teal)" strokeWidth="1.5" opacity="0.85" />
 </svg>
 ...
 <span className="w-3 h-0.5" style={{ backgroundColor: 'var(--color-teal)' }} />
