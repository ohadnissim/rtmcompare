...
export default function ClientReportButton({ results, fileA, fileB }: Props) {
 ...
 {open && !busy && (
 <div
 className="absolute right-0 top-full mt-1 z-50 py-1 min-w-[300px] max-h-[60vh] overflow-y-auto"
 ...
 <label htmlFor="client-report-reviewer" className="text-[11px] uppercase tracking-[0.16em]" style={{ color: 'var(--color-text-muted)' }}>
 Reviewer (on every report)
 </label>
 <input
 id="client-report-reviewer"
 type="text"
 value={reviewer}
...
<body class="mode-${opts.mode}">
 ...
 <p style="font-size:8.5pt;color:#8d867b;margin-top:4pt;font-family:'Instrument Serif', Georgia, serif;font-style:italic">Post-normalisation playback loudness per platform. ⚠ = limiter engages.</p>
 ` : ''}
 ...
 <p style="font-size:9.5pt;color:#7a7164;margin:-4pt 0 8pt;font-family:'Instrument Serif', Georgia, serif;font-style:italic">${opts.mode === 'engineer'
...
<p style="font-size:9.5pt;color:#7a7164;margin:-4pt 0 6pt;font-family:'Instrument Serif', Georgia, serif;font-style:italic">${
    mode === 'engineer'
