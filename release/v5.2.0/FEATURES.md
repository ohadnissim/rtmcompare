...
**v5.0.8** · macOS arm64 + Windows x64 · everything runs locally · no
...
Demucs separation: vocals / drums / bass / other. Each stem gets
its own AI-content verdict. The point is to tell you *where* the
suspicion lives — a vocal-cloned-but-organic-instrumentation mix
scores very differently from a fully synthetic one, and you'd
want to know which one is on your desk.
